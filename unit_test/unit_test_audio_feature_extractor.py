...
def segmenter_test(dimensions, overlap, config):
    ...
    new_feat, _, _, _, _ = audio_feature_extractor.logmel_segmenter(
        log_spec_test, 300, 1, 10, dimensions, feature_overlap=overlap)
...
def run_tests_afe(config):
    ...
    # TODO this no longer works with overlap - code has changed in
